...
export function exercise08(year) {
  ...
  //tambien puede ser de froma manual sin el objeto Math que incorpora js (linea 10 y 11)
  //let yearInString=new String(year);
  //let century=Number(yearInString.substring(0,2))+1;
